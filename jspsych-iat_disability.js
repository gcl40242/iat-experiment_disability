...
var category_block = {
  type: 'html-keyboard-response',
  stimulus: 
  '<p>“eキー”と“iキー”を使用して、画面に表示される単語を、できるだけ素早く各カテゴリーに分類してください。<br>' +
  '以下は、3つのカテゴリーと、各カテゴリーに属する単語です。よく読んでから、スペースキーを押して進んでください。:</p><br>' +
  '<strong>良い</strong>:<br>' + 
  '好感の持てる、格好の良い、素晴らしい、美しい<br><br>' + 
  '<strong>悪い</strong>:<br>' + 
  '嫌悪感のある、見苦しい、卑しい、汚らしい<br><br>' +
  '<strong>障害者</strong>:<br>' + 
  '障害のある、支援が必要な、車いすに乗った、発達が遅れた<br><br>',
  post_trial_gap: 1500
};
...
//5.本番試行の教示文(悪い + 障害者 / 良い)
var instructions_block2 = {
  type: 'html-keyboard-response',
  stimulus: 
  "<div style='position: absolute; top: 18%; left: 20%'>eキーを押す:<br> " +
  "<strong>悪い</strong><br>" + "または<br>" + "<strong>障害者</strong></div>" + 
  ...
  "悪いカテゴリー/障害者カテゴリーの単語が表示されたら<strong>eキー</strong>を、<br>" +
  ...
  timeline: [
    {
      ...
      left_category_key: 'e',
      right_category_key: 'i',
      left_category_label: ['悪い', '障害者'],
      right_category_label: ['良い', '　　'],
      response_ends_trial: true,
      data: { iat_type: '悪い-障害者L' }
    }
  ],

  //IATで使う刺激
  timeline_variables: [
    {type: 'iat-html', stimulus: "障害のある", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "支援が必要な", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "車いすに乗った", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "発達が遅れた", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "嫌悪感のある", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "見苦しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "卑しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "汚らしい", stim_key_association: "left"},
...
var instructions_block3 = {
  ...
  "良いカテゴリー/障害者カテゴリーの単語が表示されたら<strong>iキー</strong>を押してください。<br>" +
  "どの単語も、ひとつのカテゴリーにのみ属しています。</p><p>" +
  "分類を間違えた場合、赤色でXマークが表示されます。正しいキーを押し直して、課題を続行してください。<br>" +
  ...
  timeline: [
    {
      ...
      right_category_key: 'i',
      left_category_label: ['悪い', '　　'],
      right_category_label: ['良い', '障害者'],
      response_ends_trial: true,
      data: { iat_type: '良い-障害者R' }
    }
  ],

  //IATで使う刺激
  timeline_variables: [
    {type: 'iat-html', stimulus: "障害のある", stim_key_association: "right"},
    {type: 'iat-html', stimulus: "支援が必要な", stim_key_association: "right"},
    {type: 'iat-html', stimulus: "車いすに乗った", stim_key_association: "right"},
    {type: 'iat-html', stimulus: "発達が遅れた", stim_key_association: "right"},
    {type: 'iat-html', stimulus: "嫌悪感のある", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "見苦しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "卑しい", stim_key_association: "left"},
    {type: 'iat-html', stimulus: "汚らしい", stim_key_association: "left"},
...
var instructions_block4 = {
  ...
  "<strong>悪い</strong><br>" + "　　　<br>" + "<strong>　　　</strong></div>" +
  "<div style='position: relative; top: 42%; margin-left: auto; margin-right: auto'><br><br><br><br><br><p>"+
  "良いカテゴリー/障害者カテゴリーの単語が表示されたら<strong>eキー</strong>を<br>" +
  ...
  timeline: [
    {
      ...
      left_category_key: 'e',
      right_category_key: 'i',
      left_category_label: ['良い', '障害者'],
      right_category_label: ['悪い', '　　'],
      response_ends_trial: true,
      data: { iat_type: '良い-障害者L' }
    }
  ],
...
var instructions_block5 = {
  ...
  "悪いカテゴリー/障害者カテゴリーの単語が表示されたら<strong>iキー</strong>を押してください。<br>" +
  "どの単語も、ひとつのカテゴリーにのみ属しています。</p><p>" +
  "分類を間違えた場合、赤色でXマークが表示されます。正しいキーを押し直して、課題を続行してください。<br>" +
  "できるだけ素早く、正確に回答してください。</p><p>" +
  "準備ができたら、スペースキーを押して開始してください。</p><p></div>",
  ...
  timeline: [
    {
      ...
      right_category_label: ['悪い', '障害者'],
      response_ends_trial: true,
      data: { iat_type: '悪い-障害者R' }
    }
  ],
